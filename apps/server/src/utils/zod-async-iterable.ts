...
>(opts: {
   ...
   */
  // biome-ignore lint/suspicious/noExplicitAny: Copied from TRPC docs https://trpc.io/docs/server/subscriptions#example-with-zod
  ...
  return z
    ...
    .transform(async function* (iter) {
      ...
      try {
        // biome-ignore lint/suspicious/noExplicitAny: Copied from TRPC docs https://trpc.io/docs/server/subscriptions#example-with-zod
        let next: any;
        // biome-ignore lint/suspicious/noAssignInExpressions: Copied from TRPC docs https://trpc.io/docs/server/subscriptions#example-with-zod
